...
fun CustomBottomBar(
    ...
    BottomNavigation(
        elevation = MaterialTheme.sizes.small, backgroundColor = DeepBlue
    ) {
        ...
        items.forEachIndexed { index, bottomMenuContent ->
            ...
            BottomNavigationItem(selectedContentColor = AquaBlue,
...
val features: List<Feature> = listOf(
    Feature(
        ...
        title = "Night island", R.drawable.ic_headphone, OrangeYellow1, OrangeYellow2, OrangeYellow3
    ), Feature(
        title = "Calming sounds", R.drawable.ic_videocam, Beige1, Beige2, Beige3
    ), Feature(
        title = "Sleep meditation", R.drawable.ic_headphone, BlueViolet1, BlueViolet2, BlueViolet3
    ), Feature(
        title = "Tips for sleeping", R.drawable.ic_videocam, LightGreen1, LightGreen2, LightGreen3
